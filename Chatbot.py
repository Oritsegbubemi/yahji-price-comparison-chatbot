...
#from MyJumia_Scrape import url_request
#from MyKara_Scrape import url_request
#from MyDealday_Scrape import url_request
...
def specify():
    details=["You have to specify","Type: ","Price range: " ]
    print(details[0])
